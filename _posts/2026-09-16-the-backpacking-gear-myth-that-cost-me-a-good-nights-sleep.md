...
author: James Rivera
excerpt: "Getting into backpacking can appear to be more complicated than it
  actually is. Frequent questions include: What kind of backpack, tent, or
  sleeping bag do I need? What supplies should I bring? With so many brands and
  brand ambassadors endorsing a certain brand or type of gear, it can all be a
...
Starting with the sleep system — what is it? It's actually three items that generally make up the system. The bottom layer is usually a closed-cell foam mat, which blocks the ground from stealing your heat at night. The middle layer is a sleeping pad — these can be inflated to give you a more comfortable experience, like a little air mattress. The closed-cell foam mat and sleeping pad can be used together or separately, but a sleeping pad alone makes for a more comfortable sleep than a closed-cell foam mat alone. Third, and most important, is your sleeping bag.

Each item has its own R-value, which rates its insulating properties, and this can vary by piece of gear. The higher the R-value, the better the insulation.

There are pros and cons to a higher or lower R-value. A higher value means you'll lose less heat at night but will weigh more, whereas a lower R-value will be lighter but can't be used in low temps.

On a sleeping bag, there are usually two temperature ratings: a comfort rating and a minimum rating. The comfort rating refers to the lowest temperature you can sleep in comfortably, and the minimum rating is the lowest temperature your bag will keep you alive in.

The R-value and temperature rating you need will vary depending on the season and conditions you'll be hiking in. Try to look for R-values on products that are tested using the ASTM F3340 standard. Keep in mind that manufacturers self-report their results, so if a product's R-value isn't based on the ASTM F3340 standard, there's a good chance the number is made up.



Moving on to your tent. There are many great tents out there, from cheap, under-$100 backpacking tents to multi-thousand-dollar tents. Again, like all the other gear, knowing what your intended purpose is matters more than what brand you use.



There are three main forms of tent:



Freestanding tents: These stand on their own without needing stakes. Great for beginners, since they're very easy to set up and move around.

Semi-freestanding tents: These use tent poles for most of the structure but require a few corners or the vestibule to be staked out to be fully pitched.

Freestanding and semi-freestanding tents can be single-wall or double-wall. Single-wall is just one layer of waterproof fabric — it saves weight but can have increased condensation in the morning. Double-wall combines an inner mesh body with a separate outer rainfly, which costs weight but reduces condensation.
